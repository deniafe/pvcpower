  ...
  return (
    <main>
      <Box
              ...
              py={5}
            >
               <Image src='./no-reviews.svg' zIndex={2} alt="Map Pointer" w='380px' h='380px' mt='120px' ml='120'/>
            </Box>
         <Box
              display="flex" 
              alignItems="center" 
            ...
            >
                <Text fontSize={24} color={'#706C6C'}>
                  There are no reviews available yet. You can be the first to post a review
                </Text>
            </Box>
    </main>
  )
